...
def get_json_filepath(filename="charge_command.json"):
    # 절대 경로를 명시적으로 지정
    return os.path.join("C:\\Users\\SSAFY\\Desktop\\ws\\src\\sub1\\sub1", filename)
...
class GoalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.map_offset_x = -2 - 8.75   # 예시로 맵의 x축 오프셋
        self.map_offset_y = -2 - 8.75   # 예시로 맵의 y축 오프셋
    ...
    def publish_goal(self):
        ...
        self.get_logger().info(f'Publishing goal pose: x={msg.pose.position.x}, y={msg.pose.position.y}, vehicleNumber={data["carNumber"]}')
