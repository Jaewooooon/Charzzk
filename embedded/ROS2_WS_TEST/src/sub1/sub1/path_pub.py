...
class pathPub(Node):
    ...
    def timer_callback(self):
        print("path pub start", flush=True)
        local_path_msg = Path()
        ...
        #C:\Users\SSAFY\Desktop\ws\src\ssafy_bridge\launch
        self.f = open('C:\\Users\\SSAFY\\Desktop\\ros2_ws\\src\\sub1\\sub1\\tg.txt', 'r')
        first_line = self.f.readline().strip()  # 첫 번째 줄 읽기
        ...
        for line in lines:
            ...
            if len(tmp) == 2:
                try:
                    ...
                    print("skipping line due", flush=True)
        ...
        # print("path_pub publisher", flush=True)
