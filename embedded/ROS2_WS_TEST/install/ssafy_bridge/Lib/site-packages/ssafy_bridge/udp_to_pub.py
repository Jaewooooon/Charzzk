...
# local - local 일때
user_ip='127.0.0.1'
# user_ip = '172.28.172.241'

'''
# sim -> user
# UDP 통신을 통해 수신한 데이터를 여러 토픽으로 발행하겠다.
...
class ssafy_bridge(Node):
    ...
    def __init__(self):
        ...
        #turtlebot status
        '''
        ego_status_publisher : 'turtlrbot_status'토픽 발행 선언
        erp_udp_parser : user_ip와 포트를 통해서 UDP로 데이터를 수신한 후 / turtlebot_status 토픽으로 발행하겠다
