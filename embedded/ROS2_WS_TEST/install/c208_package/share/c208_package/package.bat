...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\c208_package\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\c208_package\hook\ament_prefix_path.bat"
